...
CREATE INDEX `batch_item_status_created_idx` ON `batch` (`item_id`,`status`,`created_date`);--> statement-breakpoint
CREATE INDEX `batch_location_id_idx` ON `batch` (`location_id`);--> statement-breakpoint
CREATE INDEX `batch_supplier_id_idx` ON `batch` (`supplier_id`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX `count_started_date_idx` ON `count` (`started_date`);--> statement-breakpoint
CREATE INDEX `count_finished_date_idx` ON `count` (`finished_date`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX `item_count_item_id_idx` ON `item_count` (`item_id`,`count_id`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX `item_form_item_id_idx` ON `item_form` (`item_id`);--> statement-breakpoint
CREATE TABLE `item` (
	`id` text PRIMARY KEY NOT NULL,
	`name` text NOT NULL,
	`uom` text NOT NULL,
